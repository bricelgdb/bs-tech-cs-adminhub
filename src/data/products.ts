...
export const products: Product[] = [
  { id: "adobe-cc", name: "Adobe Creative Cloud Suite", domain: ["Design", "Photo", "Video"], seats: 142, utilisation: 89, costMonthly: 9240, renewal: "2026-09-01", status: "active", description: "Industry-standard creative apps including Photoshop, Illustrator, InDesign, Premiere Pro, and After Effects.", adminUrl: "https://adminconsole.adobe.com" },
  { id: "ai-studioone", name: "BESTSELLER AI StudioOne", domain: ["GenAI", "Design"], seats: 88, utilisation: 94, costMonthly: 0, renewal: null, status: "active", description: "BESTSELLER's proprietary AI-powered creative platform for generating and editing visual content at scale.", adminUrl: "https://studioone.bestseller.com/admin" },
  { id: "capture-one", name: "Capture One Studio", domain: ["Photo"], seats: 37, utilisation: 81, costMonthly: 1840, renewal: "2026-08-01", status: "active", description: "Professional photo editing and tethered capture software for fashion and product photography.", adminUrl: "https://account.captureone.com" },
  { id: "creative-force", name: "Creative Force", domain: ["Photo", "Production"], seats: 54, utilisation: 76, costMonthly: 3100, renewal: "2026-07-01", status: "active", description: "End-to-end content production workflow management for eCommerce photography and video.", adminUrl: "https://app.creativeforce.io/admin" },
  { id: "pantone", name: "Pantone Connect", domain: ["Design", "Colour"], seats: 22, utilisation: 64, costMonthly: 480, renewal: "2026-04-28", status: "expiring", description: "Colour matching and palette management tool integrated with Adobe and design workflows.", adminUrl: "https://connect.pantone.com" },
